...
class LayoutLMv3GithubPreTrainedModel(PreTrainedModel):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.
    """

    config_class = LayoutLMv3GithubConfig
    base_model_prefix = "layoutlmv3_github"
...
class LayoutLMv3GithubModel(LayoutLMv3GithubPreTrainedModel):
    """
    """
...
class LayoutLMv3GithubForTokenClassification(LayoutLMv3GithubPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.layoutlmv3 = LayoutLMv3GithubModel(config)
        self.dropout = nn.Dropout(config.hidden_dropout_prob)
...
class LayoutLMv3GithubForQuestionAnswering(LayoutLMv3GithubPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class LayoutLMv3GithubForSequenceClassification(LayoutLMv3GithubPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
